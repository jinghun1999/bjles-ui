...
@Component({
  selector: 'app-part-partstockhistory',
  templateUrl: './partstockhistory.component.html',
})
export class PartPartstockhistoryComponent implements OnInit {
  actionPath = 'PartManagement/PartStockHistoryList.aspx';
  searchPath = '/part/GetPartStockHistoryPager';
