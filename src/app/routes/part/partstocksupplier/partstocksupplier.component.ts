...
import { PartPartstocksupplierEditComponent } from './edit/edit.component';

@Component({
  selector: 'app-part-partstocksupplier',
  templateUrl: './partstocksupplier.component.html',
})
export class PartPartstocksupplierComponent implements OnInit {
  actionPath = 'PartManagement/PartStockSupplierList.aspx';
  searchPath = '/part/GetPartStockSupplierPager';
  @ViewChild('st', { static: false }) st: STComponent;
  columns: STColumn[] = [
    { title: '', index: ['Id'], type: 'checkbox', width: 40, exported: false },
    {
      title: '操作',
      width: 60,
      buttons: [
        {
          ...
          modal: {
            size: 'xl',
            component: PartPartstocksupplierEditComponent,
          },
        },
      ],
    },
