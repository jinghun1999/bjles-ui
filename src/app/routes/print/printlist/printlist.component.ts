...
import { PrintPrintlistEditComponent } from './edit/edit.component';

@Component({
  selector: 'app-print-printlist',
  templateUrl: './printlist.component.html',
})
export class PrintPrintlistComponent implements OnInit {
  actionPath = 'PrintManagement/PrintList.aspx';
  searchPath = '/print/GetPrintPager';
  @ViewChild('st', { static: false }) st: STComponent;
  columns: STColumn[] = [
    { title: '', index: ['plant', 'supplier', 'printer_name'], type: 'checkbox', exported: false },
  ...
  Create() {
    this.modal.create(PrintPrintlistEditComponent, { record: { add: true } }, { size: 'xl' }).subscribe(res => {
