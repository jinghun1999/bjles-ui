...
@Component({
  selector: 'app-wm-inboundconfirmlist-edit',
  templateUrl: './edit.component.html',
})
export class WmInboundconfirmlistEditComponent implements OnInit {
  constructor(
  ...
  expandForm = true;
  dataAction: any[] = [];
  actionPath = 'WMManagement/InboundConfirmDetailEdit.aspx';
  ...
  getData() {
    let url = '/wm/GetInboundConfirmDetailPager?InboundConfirmId=' + this.record.InboundConfirmId + '&part_no=';
