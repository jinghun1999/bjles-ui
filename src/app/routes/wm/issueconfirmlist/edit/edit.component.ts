...
@Component({
  selector: 'app-wm-issueconfirmlist-edit',
  templateUrl: './edit.component.html',
})
export class WmIssueconfirmlistEditComponent implements OnInit {
  constructor(
  ...
  expandForm = true;
  dataAction: any[] = [];
  actionPath = 'WMManagement/IssueConfirmDetailEdit.aspx';
  ...
  getData() {
    let url = '/wm/GetIssueConfirmDetailPager?IssueConfirmId=' + this.record.IssueConfirmId + '&part_no=';
