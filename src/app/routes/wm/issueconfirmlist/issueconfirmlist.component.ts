...
import { WmIssueconfirmlistEditComponent } from './edit/edit.component';

@Component({
  selector: 'app-wm-issueconfirmlist',
  templateUrl: './issueconfirmlist.component.html',
})
export class WmIssueconfirmlistComponent implements OnInit {
  actionPath = 'WMManagement/IssueConfirmQueryList.aspx';
  searchPath = '/wm/GetIssueConfirmPager';
  @ViewChild('st', { static: false }) st: STComponent;
  columns: STColumn[] = [
    { title: '', index: ['IssueConfirmId'], type: 'checkbox', exported: false },
    {
      title: '操作',
      buttons: [
        {
          ...
          modal: {
            size: 'xl',
            component: WmIssueconfirmlistEditComponent,
          },
        },
      ],
    },
    { title: '出库请求单号', index: 'RequestSheetNo', sort: true },
    { title: '出库确认单号', index: 'ConfirmSheetNo', sort: true },
