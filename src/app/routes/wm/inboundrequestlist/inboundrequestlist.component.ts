...
import { WmInboundrequestlistEditComponent } from './edit/edit.component';

@Component({
  selector: 'app-wm-inboundrequestlist',
  templateUrl: './inboundrequestlist.component.html',
})
export class WmInboundrequestlistComponent implements OnInit {
  actionPath = 'WMManagement/InboundRequestQueryList.aspx';
  searchPath = '/wm/GetInboundRequestPager';
  @ViewChild('st', { static: false }) st: STComponent;
  columns: STColumn[] = [
    { title: '', index: ['InboundRequestId'], type: 'checkbox', exported: false },
    {
      title: '操作',
      buttons: [
        {
          ...
          modal: {
            size: 'xl',
            component: WmInboundrequestlistEditComponent,
          },
        },
      ],
    },
    { title: '入库请求单号', index: 'RequestSheetNo', sort: true },
  ...
  Create() {
    // this.modal.create(WmInboundrequestlistEditComponent, { record: { add: true } }, { size: 'xl' }).subscribe(res => {
