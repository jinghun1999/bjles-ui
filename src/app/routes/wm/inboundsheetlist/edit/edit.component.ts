...
@Component({
  selector: 'app-wm-inboundsheetlist-edit',
  templateUrl: './edit.component.html',
})
export class WmInboundsheetlistEditComponent implements OnInit {
  constructor(
  ...
  expandForm = true;
  dataAction: any[] = [];
  actionPath = 'WMManagement/InboundSheetDetailEdit.aspx';
  ...
  getData() {
    let url = '/wm/GetInboundSheetDetailPager?InboundId=' + this.record.InboundId + '&part_no=';
