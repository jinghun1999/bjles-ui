...
@Component({
  selector: 'app-wm-issuerequestlist-edit',
  templateUrl: './edit.component.html',
})
export class WmIssuerequestlistEditComponent implements OnInit {
  constructor(
  ...
  expandForm = true;
  dataAction: any[] = [];
  actionPath = 'WMManagement/IssueRequestDetailEdit.aspx';
  ...
  getData() {
    let url = '/wm/GetIssueRequestDetailPager?IssueRequestId=' + this.record.IssueRequestId + '&part_no=';
