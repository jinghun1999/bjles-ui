...
import { SupplierRespondlistEditComponent } from './edit/edit.component';
import { format } from 'date-fns';

@Component({
  selector: 'app-supplier-respondlist',
  templateUrl: './respondlist.component.html',
})
export class SupplierRespondlistComponent implements OnInit {
  actionPath = 'SupplierManagement/RespondList.aspx';
  searchPath = '/supplier/GetRespondPager';
  ...
  columns: STColumn[] = [
      ...
      buttons: [
        {
          ...
          modal: {
            size: 'xl',
            component: SupplierRespondlistEditComponent,
          },
        },
      ],
    },
    ...
    { title: '响应时间(分)', index: 'online_time', sort: true },
  ];
  selectedRows: STData[] = [];
  ...
  Create() {
    this.modal.create(SupplierRespondlistEditComponent, { record: { add: true } }, { size: 'xl' }).subscribe(res => {
