...
@Component({
  selector: 'app-supplier-respondlist-edit',
  templateUrl: './edit.component.html',
})
export class SupplierRespondlistEditComponent implements OnInit {
  record: any;
  ...
  save() {
    ...
    this.http.post('/supplier/RespondSave', this.record).subscribe(
      (res: any) => {
        if (res.successful) {
