...
@Component({
  selector: 'app-supplier-purchasinglist',
  templateUrl: './purchasinglist.component.html',
})
export class SupplierPurchasinglistComponent implements OnInit {
  actionPath = 'SupplierManagement/SupplierPurchasingList.aspx';
  searchPath = '/supplier/GetPurchasingPager';
  ...
  columns: STColumn[] = [
      ...
      buttons: [
        {
          ...
          modal: {
            size: 'xl',
            component: SupplierPurchasinglistEditComponent,
          },
        },
      ],
    },
    ...
    { title: '收货方式', index: 'receipt_type_name', sort: true },
  ...
  import() {
    ...
    this.xlsx.import(file).then(res1 => {
      ...
      // }
      this.http
        .post('/supplier/PurchasingImportData', res1)
