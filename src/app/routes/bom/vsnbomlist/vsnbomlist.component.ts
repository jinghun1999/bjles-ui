...
@Component({
  selector: 'app-bom-vsnbomlist',
  templateUrl: './vsnbomlist.component.html',
})
export class BomVsnbomlistComponent implements OnInit {
  actionPath = 'BOMManagement/VSNBOMQuery.aspx';
  searchPath = '/BOM/GetVSNBOMPager';
