...
@Component({
  selector: 'app-system-eventlist',
  templateUrl: './eventlist.component.html',
})
export class SystemEventlistComponent implements OnInit {
  actionPath = 'SystemManagement/EventList.aspx';
  searchPath = '/system/GetEventPager';
  @ViewChild('st', { static: false }) st: STComponent;
  columns: STColumn[] = [
    { title: '', index: ['event_id'], type: 'checkbox', exported: false },
    { title: '事件标识符', index: 'event_id', sort: true },
