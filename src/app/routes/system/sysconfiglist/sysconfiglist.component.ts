...
import { SystemSysconfiglistEditComponent } from './edit/edit.component';

@Component({
  selector: 'app-system-sysconfiglist',
  templateUrl: './sysconfiglist.component.html',
})
export class SystemSysconfiglistComponent implements OnInit {
  actionPath = 'SystemManagement/SysConfigList.aspx';
  searchPath = '/system/GetSysConfigPager';
      ...
      buttons: [
        {
          ...
          type: 'modal',
          click: 'reload',
          iif: item => item.changeable,
          modal: {
            size: 'xl',
            component: SystemSysconfiglistEditComponent,
          },
        },
      ],
    },
    { title: '参数名', index: 'parameter_name', sort: true },
    { title: '参数值', index: 'parameter_value', sort: true },
    { title: '参数描述', index: 'parameter_description', sort: true },
  ...
  Create() {
    this.modal.create(SystemSysconfiglistEditComponent, { record: { add: true } }, { size: 'xl' }).subscribe(res => {
